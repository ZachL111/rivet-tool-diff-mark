"""Regression checks for the rivet-tool-diff-mark casebook."""
...
from casebook.harness import assert_expected, rivet_tool_diff_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_tool_diff_mark_summary(), assert_expected())
